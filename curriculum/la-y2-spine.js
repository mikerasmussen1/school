...
(function(){
  ...
  const STANDARDS = [
    ...
    {tag:"W.5.2", text:"Informative/explanatory writing with headings, facts, definitions and precise language.", weeks:"Unit 6 project; handwriting lessons"},
    {tag:"W.5.3", text:"Narrative writing with dialogue, description, pacing and transitions.", weeks:"Unit 4 project; handwriting lessons"},
    {tag:"W.5.4", text:"Produce clear and coherent writing appropriate to task, purpose and audience.", weeks:"the handwriting lesson every week; 32"},
    {tag:"W.5.5", text:"Develop and strengthen writing by planning, revising, editing and rewriting.", weeks:"the handwriting lesson every week"},
    ...
    {tag:"W.5.10", text:"Write routinely over extended and shorter time frames.", weeks:"the handwriting lesson every week"},
    {tag:"SL.5.1", text:"Engage effectively in collaborative discussions; pose and respond to specific questions.", weeks:"the speaking lesson every week"},
    {tag:"SL.5.2", text:"Summarize a text read aloud or information from diverse media.", weeks:"speaking lessons, Units 1, 3"},
    {tag:"SL.5.3", text:"Summarize a speaker's points and explain how each claim is supported.", weeks:"speaking lessons, Units 3, 9"},
    {tag:"SL.5.4", text:"Report on a topic or present an opinion, sequencing ideas logically.", weeks:"36; speaking lessons"},
