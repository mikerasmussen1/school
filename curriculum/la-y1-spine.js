...
(function(){
  ...
  const STANDARDS = [
    ...
    {tag:"W.3.1", text:"Opinion writing: introduce the topic, state an opinion, give reasons, use linking words, provide a conclusion.", weeks:"handwriting lessons; Unit 3 and 9 projects"},
    {tag:"W.3.2", text:"Informative/explanatory writing: introduce a topic, group related information, develop with facts and details, conclude.", weeks:"handwriting lessons; Unit 2 and 6 projects"},
    {tag:"W.3.3", text:"Narrative writing: establish a situation, introduce characters, use dialogue and description, provide closure.", weeks:"handwriting lessons; Unit 5 and 8 projects"},
    {tag:"W.3.4-6", text:"Plan, revise and edit with guidance; use technology to produce and publish.", weeks:"the handwriting lesson every week; Unit 9"},
    {tag:"W.3.8",  text:"Conduct short research projects; take notes and sort evidence.", weeks:"33, 34"},
    {tag:"W.3.10", text:"Write routinely over short and extended time frames.", weeks:"the handwriting lesson every week"},
    {tag:"SL.3.1", text:"Participate in collaborative discussions, building on others' ideas.", weeks:"the speaking lesson every week"},
    {tag:"SL.3.2", text:"Determine main ideas and supporting details presented orally or in media.", weeks:"speaking lessons, Units 2, 5, 8"},
    {tag:"SL.3.3", text:"Ask and answer questions about a speaker's information.", weeks:"speaking lessons, Units 3, 6"},
    {tag:"SL.3.4", text:"Report on a topic or text, tell a story, or recount an experience.", weeks:"the speaking lesson every week; Week 36"},
    ...
    {tag:"RF.3.4", text:"Read grade-level text orally with accuracy, appropriate rate and expression.", weeks:"the reading lesson every week"},
    {tag:"RL/RI.3.10", text:"Read and comprehend at the high end of the 2–3 band (Lexile ~420–820).", weeks:"the reading lesson every week"}
  ];
