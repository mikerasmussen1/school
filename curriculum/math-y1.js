...
const UNITS = [
  {n:1,name:"Multiplication Masters",short:"Multiplication Masters",color:"#FF9F1C",weeks:"1–5",badge:"×",size:96,glyph:"42px",
   ...
   practice:"That's the structure — the actual problems live in two places. Today has all of Week 1 on screen, graded instantly. The print pack has the same work as worksheets with show-your-work space.",
   weeksNote:"All five weeks have graded sets in Today, and the worksheets file prints every one of them.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:2,name:"Division Decoded",short:"Division Decoded",color:"#2DD4BF",weeks:"6–10",badge:"÷",size:78,glyph:"36px",
   ...
   practice:"Week 1 of this mission is on screen in Today, graded instantly. The print pack has the same work as worksheets with room to draw the rectangles.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:3,name:"Number Power",short:"Number Power",color:"#A78BFA",weeks:"11–14",badge:"10\u00b3",size:70,glyph:"22px",
   ...
   practice:"Four weeks instead of five — the mid-unit quiz lands at the end of Week 3 and the test a week later. Week 1 is on screen in Today and in the print pack.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:4,name:"Fraction Universe",short:"Fraction Universe",color:"#F472B6",weeks:"15–20",badge:"¾",size:88,glyph:"34px",
   ...
   practice:"Six weeks, so the mid-unit quiz still lands at the end of Week 3 and the test three weeks later. Week 1 is on screen in Today and in the print pack.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:5,name:"Adding & Subtracting",short:"Add & Subtract",color:"#A3E635",weeks:"21–24",badge:"+\u2212",size:72,glyph:"32px",
   ...
   practice:"Practice answers are typed in cents or hundredths, so everything stays a whole number on screen. The print pack uses dollar signs and decimal points, the way a receipt does.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:6,name:"Geometry Quest",short:"Geometry Quest",color:"#60A5FA",weeks:"25–29",badge:"\u25b1",size:84,glyph:"38px",
   ...
   practice:"This mission needs a protractor and squared paper more than it needs a screen. Today covers the arithmetic; the drawing lives in the print pack.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:7,name:"Data Detective",short:"Data Detective",color:"#FB7185",weeks:"30–34",badge:"▮▮",size:66,glyph:"18px",
   ...
   practice:"This is the only mission where the data has to come from outside the house. Twenty real people, tallied as they answer — Today handles the arithmetic.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus one “explain your thinking.” The explanation is scored on reasoning, not neatness."},
  {n:8,name:"Algebra Sparks",short:"Algebra Sparks",color:"#FCD34D",weeks:"35–38",badge:"x",size:80,glyph:"38px",
   ...
   practice:"Week 4 is the capstone. Ten stops, one problem per stop in his own handwriting, and every mission of the year has to appear somewhere on the trail.",
   weeksNote:"Every week is written out in full — printable worksheets with answer keys for the whole mission.",
   testNote:"12 questions plus the completed Math Trail. The trail is scored on whether the problems are solvable, not on how hard they are."}
];
