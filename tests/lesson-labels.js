...
{ const c=new C(); c.state.landed=true; c.state.year="y2"; c.state.week=20; c.state.day="Thu"; c.startDay();
  ...
  if(!endBtn.length || endBtn.some(b=>b!=="Finish this lesson and get your reward!")) fail.push("the last step's button reads: "+endBtn.join(", "));
  if(/>Finish this lesson<|"Finish this lesson"/.test(h)) fail.push("a plain \"Finish this lesson\" is still on the page");
