...
const UNITS_Y5 = [
  ...
  {n:2,name:"Big Multiplication",short:"Big Multiplication",color:"#FF9F1C",weeks:"5–8",badge:"×",size:80,glyph:"38px",
  ...
  {n:3,name:"Long Division",short:"Long Division",color:"#2DD4BF",weeks:"9–12",badge:"÷",size:86,glyph:"38px",
  ...
  {n:4,name:"Decimal Operations",short:"Decimal Operations",color:"#A3E635",weeks:"13–17",badge:".7",size:76,glyph:"32px",
  ...
  {n:5,name:"Fraction Sums",short:"Fraction Sums",color:"#F472B6",weeks:"18–22",badge:"⅞",size:90,glyph:"34px",
  ...
  {n:6,name:"Fraction Products",short:"Fraction Products",color:"#A78BFA",weeks:"23–27",badge:"½×",size:84,glyph:"25px",
  ...
  {n:7,name:"Volume & Measure",short:"Volume & Measure",color:"#FBBF24",weeks:"28–31",badge:"㎥",size:78,glyph:"24px",
  ...
  {n:8,name:"Coordinate Geometry",short:"Coordinate Geometry",color:"#FB7185",weeks:"32–35",badge:"xy",size:82,glyph:"28px",
...
const STANDARDS_Y5 = {
 1:[{code:"5.NR.1",level:"on-grade",where:"Weeks 1–4",text:"Place value: a digit represents 10 times the place to its right and 1/10 of the place to its left. Patterns when multiplying or dividing by powers of 10, using whole-number exponents up to 10³."},
    {code:"5.NBT.A.1",level:"on-grade",where:"Week 1",text:"Recognise that a digit in one place represents ten times what it represents to its right and 1/10 of what it represents to its left."},
    {code:"5.NBT.A.2",level:"on-grade",where:"Week 2",text:"Explain patterns in the number of zeros and in the placement of the decimal point when multiplying or dividing by powers of 10; denote powers of 10 with exponents."},
    {code:"5.NBT.A.3.A",level:"on-grade",where:"Week 1",text:"Read and write decimals to thousandths using base-ten numerals, number names and expanded form."},
    {code:"5.NBT.A.3.B",level:"on-grade",where:"Week 1",text:"Compare two decimals to thousandths based on the meaning of the digits in each place."},
    {code:"5.NBT.A.4",level:"on-grade",where:"Week 3",text:"Use place-value understanding to round decimals to any place."}],
 2:[{code:"5.NR.2",level:"on-grade",where:"Weeks 1–4",text:"Fluently multiply up to 3-digit by 2-digit numbers."},
    {code:"5.NBT.B.5",level:"on-grade",where:"Weeks 1–2",text:"Fluently multiply multi-digit whole numbers using the standard algorithm."},
    {code:"5.NBT.A.2",level:"on-grade",where:"Week 2",text:"Multiplying by multiples of ten, carried forward from Mission 01 as the estimation tool."},
    {code:"5.OA.A.1",level:"on-grade",where:"Week 2",text:"Use parentheses and brackets in numerical expressions, and evaluate expressions with these symbols."},
    {code:"5.NF.B.4.B",level:"acceleration",where:"Week 3 ceiling",text:"Find the area of a rectangle by tiling and multiplying side lengths — the bridge to Mission 06."},
    {code:"5.MD.A.1",level:"on-grade",where:"Week 3",text:"Convert among different-sized standard measurement units when solving multi-step problems."}],
 3:[{code:"5.NR.2",level:"on-grade",where:"Weeks 1–4",text:"Fluently divide up to 4-digit dividends by 2-digit divisors no greater than 25."},
    {code:"5.NR.3",level:"on-grade",where:"Week 3",text:"Interpret a fraction as division (a/b = a ÷ b)."},
    {code:"5.NBT.B.6",level:"on-grade",where:"Weeks 1–2",text:"Find whole-number quotients of whole numbers with up to four-digit dividends and two-digit divisors."},
    {code:"5.NBT.B.6",level:"on-grade",where:"Week 1",text:"Illustrate and explain the calculation using equations, rectangular arrays or area models."},
    {code:"5.OA.A.2",level:"on-grade",where:"Week 3",text:"Write simple expressions that record calculations with numbers, and interpret them without evaluating."},
    {code:"4.OA.A.3",level:"review",where:"Week 3",text:"Interpret remainders in multi-step word problems — revisited at grade-5 number sizes."},
    {code:"5.NF.B.3",level:"on-grade",where:"Week 3 ceiling",text:"Interpret a fraction as division of the numerator by the denominator — the bridge to Mission 06."}],
 4:[{code:"5.NR.4",level:"on-grade",where:"Weeks 1–5",text:"Decimals: read, write, compare and order to the thousandths, round to the hundredths, and add and subtract to the hundredths."},
    {code:"5.NBT.B.7",level:"on-grade",where:"Week 1",text:"Add and subtract decimals to hundredths using concrete models or drawings and strategies based on place value."},
    {code:"5.NBT.B.7",level:"acceleration",where:"Week 2",text:"Multiply decimals to hundredths, relating the strategy to a written method."},
    {code:"5.NBT.B.7",level:"acceleration",where:"Week 3",text:"Divide decimals to hundredths, relating the strategy to a written method."},
    {code:"5.NBT.A.4",level:"on-grade",where:"Week 4",text:"Round decimals to estimate before computing — the error-catching habit of this mission."},
    {code:"5.MD.A.1",level:"on-grade",where:"Week 5",text:"Use decimal conversions in real measurement and money contexts."}],
 5:[{code:"5.NR.3",level:"on-grade",where:"Weeks 1–5",text:"Compare and order up to three fractions with unlike denominators, and add and subtract fractions and mixed numbers with unlike denominators."},
    {code:"5.NF.A.1",level:"on-grade",where:"Weeks 1–2",text:"Add and subtract fractions with unlike denominators by replacing them with equivalent fractions with a common denominator."},
    {code:"5.NF.A.2",level:"on-grade",where:"Week 4",text:"Solve word problems involving addition and subtraction of fractions referring to the same whole."},
    {code:"5.NF.A.2",level:"on-grade",where:"Week 3",text:"Use benchmark fractions and number sense to estimate mentally and assess the reasonableness of answers."},
    {code:"4.NF.A.1",level:"review",where:"Week 1",text:"Explain why a fraction is equivalent to another using visual models — the foundation this mission rebuilds."},
    {code:"5.NF.A.1",level:"on-grade",where:"Week 2",text:"Add and subtract mixed numbers with unlike denominators."}],
 6:[{code:"5.NR.3",level:"on-grade",where:"Weeks 1–5",text:"Multiply a fraction by a whole number, explain why multiplying by a fraction greater than or less than one changes the product, and divide a unit fraction by a whole number and a whole number by a unit fraction."},
    {code:"5.NF.B.4.A",level:"acceleration",where:"Weeks 1–2",text:"Interpret the product (a/b) × q as a parts of a partition of q into b equal parts."},
    {code:"5.NF.B.4.B",level:"acceleration",where:"Week 2",text:"Find the area of a rectangle with fractional side lengths by tiling with unit squares."},
    {code:"5.NF.B.5",level:"on-grade",where:"Week 3",text:"Interpret multiplication as scaling: compare the size of a product to one factor without performing the multiplication."},
    {code:"5.NF.B.7",level:"on-grade",where:"Week 4",text:"Divide unit fractions by whole numbers and whole numbers by unit fractions."},
    {code:"5.NF.B.3",level:"on-grade",where:"Week 4",text:"Interpret a fraction as division and solve word problems leading to answers in the form of fractions."}],
 7:[{code:"5.MDR.7",level:"on-grade",where:"Weeks 1–3",text:"Convert within the metric system and within the customary system, and apply conversions to multi-step problems."},
    {code:"5.GSR.8",level:"on-grade",where:"Weeks 3–4",text:"Find the volume of right rectangular prisms by packing with unit cubes, and discover volume as the area of the base times the height."},
    {code:"5.MD.A.1",level:"on-grade",where:"Week 1",text:"Convert among different-sized standard measurement units within a given system and use these conversions in multi-step problems."},
    {code:"5.MD.C.3",level:"on-grade",where:"Week 2",text:"Recognise volume as an attribute of solid figures and understand concepts of volume measurement."},
    {code:"5.MD.C.4",level:"on-grade",where:"Week 2",text:"Measure volumes by counting unit cubes."},
    {code:"5.MD.C.5.B",level:"on-grade",where:"Weeks 2–3",text:"Apply the formulas V = l × w × h and V = b × h to find volumes of right rectangular prisms."},
    {code:"5.MD.B.2",level:"on-grade",where:"Week 3",text:"Make a line plot to display a data set of measurements in fractions of a unit, and solve problems using the data."}],
 8:[{code:"5.PAR.6",level:"on-grade",where:"Weeks 1–3",text:"Generate two numerical patterns from two given rules, identify relationships between corresponding terms, and plot ordered pairs in the first quadrant."},
    {code:"5.GSR.8",level:"on-grade",where:"Weeks 3–4",text:"Classify polygons by their properties, understanding that attributes of a category belong to all of its subcategories."},
    {code:"5.NR.5",level:"on-grade",where:"Week 2",text:"Write, interpret and evaluate simple numerical expressions with grouping symbols."},
    {code:"5.G.A.1",level:"on-grade",where:"Week 1",text:"Use a pair of perpendicular number lines to define a coordinate system; understand that the first number indicates travel along the x-axis."},
    {code:"5.G.A.2",level:"on-grade",where:"Weeks 1–4",text:"Represent real-world and mathematical problems by graphing points in the first quadrant and interpret coordinate values."},
    {code:"5.OA.B.3",level:"on-grade",where:"Week 2",text:"Generate two numerical patterns using two given rules, form ordered pairs from corresponding terms, and graph them."},
    {code:"5.G.B.3",level:"on-grade",where:"Week 3",text:"Understand that attributes belonging to a category of two-dimensional figures also belong to all subcategories."},
    {code:"5.G.B.4",level:"on-grade",where:"Week 3",text:"Classify two-dimensional figures in a hierarchy based on properties."}]
};
