...
(function(){
  ...
  const PLANS = {
    Mon: [
      ...
      {key:"fix",   label:"Find the mistake",                gate:"score",
       detail:"One sentence with something wrong in it. Find the word.",
       done:"You found it."},
      {key:"close", label:"Read it again, looking for one thing", gate:"ack",
       detail:"The same passage, read for a different purpose, then a short piece of writing.",
       done:"You read it again and wrote your answer."},
